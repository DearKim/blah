...
A.PAGO(의료 영역) 카피에는 다음이 추가됩니다 — 자세한 내용은 [medical-compliance-03.md](medical-compliance-03.md):

- "**AI 도입 병의원**" / "**도입 병원 지도**" 등 환자 유인·알선 표현 금지 (의료법 제27조)
- "**식약처·FDA 인증**" 표기 금지, "**식약처 허가**" 사용
- 효능 단정·진단 표현 금지 (의료기기법 제24조, 의료법 제56조)
- 펫 영역에 수의사법 제32조 추가 적용
- 민감정보(건강정보) 수집 전 명시적 동의 게이트 의무
